...
class Util {
  ...
  static ByteVector buildByte1HighLookup(VectorSpecies<Byte> species) {
  ...
  static ByteVector buildByte1LowLookup(VectorSpecies<Byte> species) {
  ...
  static ByteVector buildByte2HighLookup(VectorSpecies<Byte> species) {
  ...
  static ByteVector buildIsIncompleteAnd(VectorSpecies<Byte> species) {
  ...
  static ByteVector buildIsIncompleteEq(VectorSpecies<Byte> species) {
